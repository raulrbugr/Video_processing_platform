...
#pragma SDS data mem_attribute(srcFrame:PHYSICAL_CONTIGUOUS|NON_CACHEABLE, destFrame:PHYSICAL_CONTIGUOUS|NON_CACHEABLE)
#pragma SDS data access_pattern(srcFrame:SEQUENTIAL, destFrame:SEQUENTIAL)
void DemoSobelFrameHw(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS], u32 fApp,  struct Apps* apps,char input);

void DemoSobelFrameHw2(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS], u32 fApp, struct Apps * apps, char input);
...
/*
 * funciones para testear la aplicacion directamente sin tener que ir tocando botones
 */
void TestApp();
void TestApp2();
char ** testPlugin();
