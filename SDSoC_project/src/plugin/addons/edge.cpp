...
void HardwareSobelEdge(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS])
{
	int xcoi, ycoi;
		u32 frameWidth;
...
void SoftwareSobelEdge(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS])
{
	int xcoi, ycoi;
		u32 frameWidth;
...
void Edge::apply (u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS], int hwsw) {
		//cout<<"filtro2"<<endl;
		if(hwsw ==1)
			HardwareSobelEdge(srcFrame,destFrame);
		else
			SoftwareSobelEdge(srcFrame,destFrame);
	};
