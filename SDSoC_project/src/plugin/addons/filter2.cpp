...
void HardwareSobelGray(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS])
{
	int xcoi, ycoi;
	u32 frameWidth;
...
void SoftwareSobelGray(u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS])
{
	int xcoi, ycoi;
		u32 frameWidth;
   ...
   void Filtro2::apply (u16 srcFrame[DEMO_PIXELS], u16 destFrame[DEMO_PIXELS], int hwsw) {
		//cout<<"filtro2"<<endl;
	   if(hwsw==1)
		   HardwareSobelGray(srcFrame,destFrame);
	   else
		   SoftwareSobelGray(srcFrame,destFrame);
	};
